...
from V3 import OCRVideoPlayer, VideoOCR
import flet as ft
class uiMain:
    def __init__(self):
    ...
    def main(self, page: Page):
        ...
        async def route_change(e):
            ...
            if page.route == "/login":
                ...
                self.ocr =OCRVideoPlayer(page,self.urls)
                self.ocr.setup_ui(inital_index=int(2))
                page.views.append(
                    View(
                        "/lecture1",
                        [
                            ...
                            self.ocr.video_playlist,
                            self.ocr.button_container,
                            self.ocr.ocr_results,
                ...
                self.ocr.set_video_index(int(2))
                print("이왜 안됨")
